...
> Popcorn Hack
 ...
 - Give another example of a protocol from that layer. TLS.
...
> Popcorn Hack
 ...
 - You should get 142.250.68.78, we mainly care about the bottom address for now. I got 142.250.217.142 but the link still directs to google!
...
> Popcorn Hack
 - List 4 more websites you use often and their IPs: PTable: 
...
> Popcorn Hack
 - When do we use UDP? While it seems terrible, try to think of some use cases! Streaming
 - When might we use TCP? Databases, banking, etc.
...
1. Bob wants to use the domain bob.is.the.best.com. What domain should he buy from a DNS provider (assume it is available)? What would be the subdomains? He should buy "best.com" and the subdomain should be "bob.is.the".
...
<br>
 - What protocol does HTTPS use that HTTP doesn't? SSL/TLS
